<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPotDashBoard.aspx.cs" Inherits="CMS.frmPotDashBoard" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header wow fadeInLeft">
                        ...
                        <span style="color: #0051BA">Welcome to <strong> POT Room</strong></span>
                ...
                <div class="col-md-6">
                    <div class="panel panel-info wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="panel-heading">
                            <h4>
                                <i class="fa fa-fw fa-check"></i> Bake Anode Analysis Report Block </h4>
                        </div>
                        <div class="panel-body">
                            <%--&#9998; for report--%>
                           <p>
                                    <a __designer:mapid="e" class="auto-style33"><span class="auto-style34">Baked Anode Analysis Summary Report</span></a>
                                   
                                    <a __designer:mapid="e" class="Viewcss" href="TechTeam/frmBakedAnodeAnalysisSummaryReport.aspx" runat="server"><span class="auto-style34" style="margin-left: 20px;">&#20870; Report </span></a>
                                </p>
                            &nbsp;
