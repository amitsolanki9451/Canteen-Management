<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.Master" AutoEventWireup="true" CodeBehind="frmReportDetail.aspx.cs" Inherits="SCMakingCenterLine.frmReportDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceTitleleftcorner" runat="server">
  ...
  <table id="Table3" cellspacing="0" cellpadding="0" width="100%" border="0"> 
   <tr> 
   <td style="width: 50%"> 
       <h3>Sanitization Report Detail</h3>
   </td> 
   <td> 
...
<rsweb:ReportViewer ID="rptViewer" runat="server" Width="98%" ProcessingMode="Local" Visible="true" Font-Names="Verdana" Font-Size="9pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
    <%--<LocalReport ReportPath="rptDetailwithChart.rdlc"></LocalReport> --%>
</rsweb:ReportViewer>
