...
{
    public partial class frmReportSummary : System.Web.UI.Page
    {
        ...
        private DataTable BindGridViewByResult(ML_SanitizationReport objML_SanitizationReport)
        {
            ...
            {
                objBusinessClass = new BusinessLayer.BusinessClass();
                DataSet ds = null;// objBusinessClass.GetSCSanitizationSGP125TResultBySeacrh(objML_SanitizationReport);
                if (ds.Tables.Count > 0)
                {
        ...
        private void ShowReport(long Id, String ReportType)
        {
            ...
            {
                rptViewer.LocalReport.ReportPath = "rptSummarySGP125T.rdlc";
            }
            else if (ReportType.Trim().ToLower() == "SGP4T".ToLower())
            {
                rptViewer.LocalReport.ReportPath = "rptSummarySGP4T.rdlc";
            }          
            else
            {
                rptViewer.LocalReport.ReportPath = "rptSummarywithChart.rdlc";
            }
