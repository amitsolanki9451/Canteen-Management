<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDashBoard.aspx.cs" Inherits="CMS.frmDashBoard" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header wow fadeInLeft">
                            ...
                            <span style="color: #0051BA">Welcome to <strong>Canteen Management system Dashboard</strong></span>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-info wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="panel-heading">
                                <h4>
                                    <i class="fa fa-fw fa-check"></i>Master  Block </h4>
                            </div>
                            <div class="panel-body">
                                <%--&#9998; for report--%>
                                <p>
                                    <a __designer:mapid="e" class="auto-style33"><span class="auto-style34">Canteen Name</span></a>
                                 ...
                                 <p>
                                    <a __designer:mapid="e" class="auto-style33"><span class="auto-style34">Manager Name</span></a>
                                    <a __designer:mapid="e" class="Addcss" href="~/TechTeam/frmCanteenType.aspx" runat="server">
                                        <span class="auto-style34" style="margin-left: 175px;">&#43; Add </span></a>
                                ...
                                <p>
                                    <a __designer:mapid="e" class="auto-style33"><span class="auto-style34">Function Name</span></a>
                                    <a __designer:mapid="e" class="Addcss" href="~/TechTeam/frmCanteenType.aspx" runat="server">
                                        <span class="auto-style34" style="margin-left: 175px;">&#43; Add </span></a>
                                 ...
                                 <p>
                                    <a __designer:mapid="e" class="auto-style33"><span class="auto-style34">Department Name</span></a>
                                    <a __designer:mapid="e" class="Addcss" href="~/TechTeam/frmCanteenType.aspx" runat="server">
